...
INSERT INTO `invoices` (`invoice_id`, `fk_uid`, `create_time`, `currrency`, `amount`, `settled_amount`, `status`) VALUES
(1, 1, '2018-03-01 05:18:29', 'CZK', 12.8, 0, 'pending');
...
INSERT INTO `reference` (`ref_id`, `fk_invoice_id`, `email`, `notify_url`, `order_id`, `lang`) VALUES
(1, 1, 'payer@example.org', 'http://post.me', 'boots4321', 'czech');
